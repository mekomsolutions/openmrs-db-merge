INSERT INTO encounter (encounter_id,patient_id,encounter_type,encounter_datetime,visit_id,location_id,form_id,
                               creator,date_created,changed_by,date_changed,voided,voided_by,date_voided,void_reason,uuid)

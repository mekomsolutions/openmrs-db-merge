package net.mekomsolutions.db.merge.helpers;

import static net.mekomsolutions.db.merge.Constants.PHANTOM_UUID;
import static net.mekomsolutions.db.merge.MergeUtils.getParentTableName;
import static net.mekomsolutions.db.merge.MergeUtils.isSubclassTable;
